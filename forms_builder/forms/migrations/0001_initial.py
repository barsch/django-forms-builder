    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field_type",
                    models.IntegerField(verbose_name="Type", choices=fields.NAMES),
                ),
                (
                    "required",
                ...
                (
                    "order",
                    models.IntegerField(null=True, verbose_name="Order", blank=True),
                ),
            ],
            options={
                "ordering": ("order",),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        verbose_name="Slug", unique=True, max_length=100, editable=False
                    ),
                ),
